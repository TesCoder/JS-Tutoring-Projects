 ...
 * Finally the final average/grade is displayed to the user along with the grades corresponding letter grade. If the grade is a D or an F the message will include that the student needs to retake the course.
 * @return {void}
*/
